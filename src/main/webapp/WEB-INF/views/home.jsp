...
<div class="form">
    <div class="assignment-form">
        ...
        <button class="btn-serverPaging" onclick="location.href='/serverPaging'">Server Paging</button>
        <button class="btn-dhtmlxPaging" onclick="location.href='/dhtmlxPaging'">DHTMLX Paging</button>
...
<script type="text/javascript">
    ...
    const serverPaging = $(".btn-serverPaging");
    const dhtmlxPaging = $(".btn-dhtmlxPaging");
    ...
    if (file.length > 0 && file !== null) {
        ...
        serverPaging.css("display", "none");
        dhtmlxPaging.css("display", "none");
